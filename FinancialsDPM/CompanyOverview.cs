    ...
    namespace FinancialsDPM
    {
        public class CompanyOverview
        {
            ...
            public CompanyOverview(string ticker, string assetType, string name, string description, string cik,
                ...
                string fiscalYearEnd, string latestQuarter, string marketCapitalization, string ebitda, string peRatio,
                ...
                string dividendDate, string exDividendDate)
            {
                ...
                RevenuePerShareTTM = revenuePerShareTtm ?? throw new ArgumentNullException(nameof(revenuePerShareTtm));
                ProfitMargin = profitMargin ?? throw new ArgumentNullException(nameof(profitMargin));
                OperatingMarginTTM = operatingMarginTtm ?? throw new ArgumentNullException(nameof(operatingMarginTtm));
                ...
                AnalystTargetPrice = analystTargetPrice ?? throw new ArgumentNullException(nameof(analystTargetPrice));
